...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS kurva_s_series TEXT;
...
ALTER TABLE milestones ADD COLUMN IF NOT EXISTS tgl_mulai DATE;
ALTER TABLE milestones ADD COLUMN IF NOT EXISTS tgl_selesai DATE;
ALTER TABLE milestones ADD COLUMN IF NOT EXISTS rincian TEXT;
ALTER TABLE kendalas ADD COLUMN IF NOT EXISTS pelapor TEXT;
ALTER TABLE s_curves ADD COLUMN IF NOT EXISTS pembuat TEXT;
ALTER TABLE s_curves ADD COLUMN IF NOT EXISTS bulan TEXT;
ALTER TABLE s_curve_documents ADD COLUMN IF NOT EXISTS series TEXT;
