      ...
      <div className="relative z-10 w-full max-w-sm sm:max-w-lg">
        ...
        <div className="rounded-3xl overflow-hidden shadow-2xl shadow-black/30 border border-white/10">
          ...
          <div className="bg-slate-800/95 backdrop-blur-2xl px-6 sm:px-8 pt-6 pb-8 border-t border-white/10 relative">
            ...
            <h2 className="text-xl sm:text-2xl font-extrabold text-white tracking-tight mb-1">Pendaftaran Akun</h2>
            <p className="text-xs text-slate-400 mt-1 mb-6">Isi formulir berikut untuk mendaftarkan akun sesuai peranan Anda.</p>
            ...
            <div className="flex items-center justify-center gap-2 mt-6 pt-4 border-t border-white/10 text-xs">
